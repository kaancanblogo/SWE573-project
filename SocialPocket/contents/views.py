...
class UserPostListView(LoginRequiredMixin, ListView):
    model = Post
    template_name = 'contents/user_posts.html'
    context_object_name = 'posts'
    paginate_by = 10
...
def post_detail(request, pk):
    ...
    if request.method == 'POST':
        ...
        form = NewCommentForm()
    return render(request, 'contents/post_detail.html', {'post': post, 'is_liked': is_liked, 'form': form})
...
def create_post(request):
    ...
    if request.method == "POST":
        ...
        form = NewPostForm()
    return render(request, 'contents/create_post.html', {'form': form})
...
def search_posts(request):
    ...
    return render(request, "contents/search_posts.html", context)
